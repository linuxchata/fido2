...
| `RootCertificateLocationUrl` | `https://secure.globalsign.com/cacert/rootr46.crt` | Location of GlobalSign Root R3 certificate for Metadata Service BLOB. |
| `MaximumTokenSizeInBytes` | `13107200` | Maximum token size in bytes that will be processed. This configuration is related to the Metadata Service BLOB size. |
...
<img alt="FIDO Conformance Tests" src="https://github.com/user-attachments/assets/a765b52d-5605-4074-8ec2-0846200e47bc" />
