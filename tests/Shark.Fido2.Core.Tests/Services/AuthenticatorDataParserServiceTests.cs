...
internal class AuthenticatorDataParserServiceTests
{
    ...
    [Test]
    public void Parse_WhenAuthenticatorDataHasLeftOverBytes_ThenThrowsArgumentNullException()
    {
        // Arrange
        ...
        // Act & Assert
        Assert.Throws<ArgumentOutOfRangeException>(() => _sut.Parse(authenticatorData));
    }
}