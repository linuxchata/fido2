...
internal class AttestationObjectHandlerTests
{
    ...
    [Test]
    public async Task Handle_WheniPhone8AttestationObjectValid_ThenReturnsNull()
    {
        // Arrange
    ...
    [Test]
    public async Task Handle_WheniPhone14AttestationObjectValid_ThenReturnsNull()
    {
        // Arrange
    ...
    [Test]
    public async Task Handle_WhenWindowsAttestationObjectValid_ThenReturnsNull()
    {
        // Arrange
