...
internal class AttestationObjectHandlerTests
{
    ...
    [TestCase("")]
    [TestCase("   ")]
    public async Task Handle_WhenAttestationObjectIsNullOrEmpty_ThenReturnsInternalResult(string? attestationObject)
    {
        // Arrange
    ...
    [Test]
    public async Task Handle_WhenCreationOptionsAreNull_ThenReturnsInternalResult()
    {
        // Arrange
